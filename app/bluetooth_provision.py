...
class ProvisionService:
    ...
    def _unlock_owner(self, data, request_id=None):
        ...
        The token itself never crosses BLE. The phone sends a nonce-bound HMAC
        proof and derives the same short-lived session key as the camera.
        """
